...
func TestRenderUnit(t *testing.T) {
	unit := renderUnit(service{ID: 1, Name: "local docs", WorkDir: "/home/godo docs", Port: 41000}, "/home/.local/share/godo/service")
	if !strings.Contains(unit, "WorkingDirectory=/home/godo\\x20docs\n") {
		t.Fatalf("unit has an invalid working directory:\n%s", unit)
	}
	if !strings.Contains(unit, "ExecStart=\"/home/.local/share/godo/service\"\n") {
